...
const Home = () => {
    const { initialized, loading, transactionPending, completedTodos, incompleteTodos, markTodo, removeTodo, markStaticTodo,removeStaticTodo, addStaticTodo, input,  handleChange ,initializeUser,addTodo} = useTodo()
